...
function Sandwich(bread, meat, vegetables) {
  (this.bread = bread), (this.meat = meat), (this.vegetables = vegetables);
}

let vegetables_Sandwich = new Sandwich(
  'wheat',
  ['Chorizo', 'Prosciutto', 'Pancetta'],
  ['Garlic', 'Cucumber', 'Mushrooms']
);

console.log(vegetables_Sandwich);
